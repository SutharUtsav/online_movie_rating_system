...
namespace OnlineMovieRatingSystemClient
{
    public partial class User_rate : System.Web.UI.Page
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            User_Rate.Text = "";
            IEnumerable<ServiceReference1.RatinDto3> data = client.ShowRating_Log(SessionManage.sessionId);
            if (data.Count() == 0)
            {
        ...
        protected void Button1_Click(object sender, EventArgs e)
        {
            ...
            try
            {
                ...
                ServiceReference1.User_Rating rto = new ServiceReference1.User_Rating();
        ...
        protected void GridView1_RowUpdating(object sender, GridViewUpdateEventArgs e)
        {
            ...
            ServiceReference1.RatinDto movie = new ServiceReference1.RatinDto();
            try
            {
                double rate = Convert.ToDouble(TextBox3.Text);
                if (rate > 10 || rate < 0)
